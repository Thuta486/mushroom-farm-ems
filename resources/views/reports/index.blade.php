...
@section('content')
    <div class="mb-8">
        ...
        <p class="mt-1 text-sm text-stone-500">Simple summaries for attendance, payroll, and cash advances</p>
    </div>
    ...
    <div class="grid gap-4 md:grid-cols-3">
        <a href="{{ route('reports.attendance') }}" class="group rounded-xl border border-stone-200 bg-white p-6 transition hover:border-emerald-300 hover:shadow-sm">
            ...
            <h2 class="text-lg font-semibold text-stone-900">Attendance Report</h2>
            <p class="mt-2 text-sm text-stone-500">See present and absent days by employee for any date range.</p>
        </a>
        ...
        <a href="{{ route('reports.payroll') }}" class="group rounded-xl border border-stone-200 bg-white p-6 transition hover:border-emerald-300 hover:shadow-sm">
            ...
            <h2 class="text-lg font-semibold text-stone-900">Payroll Summary</h2>
            <p class="mt-2 text-sm text-stone-500">Monthly payroll totals grouped by department.</p>
        </a>
        ...
        <a href="{{ route('reports.cash-advances') }}" class="group rounded-xl border border-stone-200 bg-white p-6 transition hover:border-emerald-300 hover:shadow-sm">
            ...
            <h2 class="text-lg font-semibold text-stone-900">Cash Advance Report</h2>
            <p class="mt-2 text-sm text-stone-500">Track advances given to workers over a period.</p>
        </a>
    </div>
@endsection
