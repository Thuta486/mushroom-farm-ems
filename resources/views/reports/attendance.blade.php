...
@section('content')
    ...
    <div class="mb-6 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div class="rounded-xl border border-stone-200 bg-white p-5">
            <p class="text-sm font-medium text-stone-500">Present Days</p>
            <p class="mt-1 text-2xl font-semibold text-emerald-700">{{ $report['summary']->present_count ?? 0 }}</p>
        </div>
        <div class="rounded-xl border border-stone-200 bg-white p-5">
            <p class="text-sm font-medium text-stone-500">Absent Days</p>
            <p class="mt-1 text-2xl font-semibold text-red-600">{{ $report['summary']->absent_count ?? 0 }}</p>
        </div>
        <div class="rounded-xl border border-stone-200 bg-white p-5">
            <p class="text-sm font-medium text-stone-500">Total Hours Worked</p>
            @php
        ...
        <table class="min-w-full divide-y divide-stone-200">
            <thead class="bg-stone-50">
                <tr>
                    ...
                    <th class="px-6 py-3 text-left text-xs font-semibold uppercase tracking-wide text-stone-500">Days Marked</th>
                    <th class="px-6 py-3 text-left text-xs font-semibold uppercase tracking-wide text-stone-500">Present</th>
                    <th class="px-6 py-3 text-left text-xs font-semibold uppercase tracking-wide text-stone-500">Absent</th>
