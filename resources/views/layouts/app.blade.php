...
<body class="min-h-screen bg-stone-100 font-sans text-stone-900 antialiased">
    <div id="app-layout" class="flex min-h-screen">
        ...
        <aside id="sidebar" class="relative flex shrink-0 flex-col border-r border-stone-200 bg-white">
            ...
            <div class="border-t border-stone-200 p-4">
                <form method="POST" action="{{ route('logout') }}">
                    @csrf
                    <button type="submit" class="flex w-full items-center gap-3 rounded-lg px-3 py-2.5 text-sm font-medium text-stone-600 hover:bg-stone-50 hover:text-stone-900">
                        <span class="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-stone-100 text-stone-500">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
        ...
        <div class="flex min-w-0 flex-1 flex-col">
            <header class="sticky top-0 z-10 flex items-center gap-3 border-b border-stone-200 bg-stone-100/95 px-4 py-3 backdrop-blur lg:px-8">
                <button
                    id="sidebar-toggle"
                    type="button"
